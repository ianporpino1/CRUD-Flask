...
- repositories/
  ...
  Na questão de Error Handling, utilizei a criação de exceções personalizadas que são 'raised' pela camada de serviço e capturadas por métodos no arquivo exceptions e geram uma response com uma mensagem e um código de erro.